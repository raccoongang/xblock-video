...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return fillValues; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return showStatus; });
/**
...
function submitBCReTranscode(profile, runtime, element) {
    $.when(
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__studio_edit_utils__["c" /* dispatch */])('POST', 'submit_retranscode_' + profile, runtime, element)
    ).then((response) => {
...
function bcLoadVideoTechInfo(runtime, element) {
    $.when(
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__studio_edit_utils__["c" /* dispatch */])('POST', 'get_video_tech_info', runtime, element)
    ).then((response) => {
...
function getReTranscodeStatus(runtime, element) {
    $.when(
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__studio_edit_utils__["c" /* dispatch */])('POST', 'retranscode-status', runtime, element)
    ).then((data) => {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__studio_edit_brightcove__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__studio_edit_utils__ = __webpack_require__(0);
/**
...
function StudioEditableXBlock(runtime, element) { // eslint-disable-line no-unused-vars
    ...
    $('.save-button', element).bind('click', function(event) {
        ...
        if (isValidated) {
            var values = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__studio_edit_utils__["a" /* fillValues */])(fields);
    ...
    function authenticateVideoApi(data) {
        ...
        .always(function() {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__studio_edit_utils__["b" /* showStatus */])(
