...
class TranscriptsMixin(XBlock):
    ...
    @staticmethod
    def _get_asset_json(
        display_name, content_type, date, location, thumbnail_location, locked
    ):
        """
    ...
    def fetch_single_3pm_translation(
        self, transcript_data, format_id=TPMApiTranscriptFormatID.WEBVTT
    ):
        """
