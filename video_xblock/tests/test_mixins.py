...
class LocationMixinTests(VideoXBlockTestBase):
    ...
    def setup_location_mock(self):
        self.xblock.location = self.location_mock = Mock()

    def test_block_id(self):
        self.setup_location_mock()
        type(self.location_mock).block_id = block_mock = PropertyMock(return_value='test_block_id')
    ...
    def test_course_key(self):
        self.setup_location_mock()
        course_key_mock = \
            type(self.location_mock).course_key = \
    ...
    def test_deprecated_string(self):
        self.setup_location_mock()
        self.location_mock.to_deprecated_string = str_mock = Mock(return_value='test_str')
