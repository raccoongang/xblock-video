...
function VideoXblockStudioEdit(runtime, element) {
    ...
    $(element).find('.field-data-control').each(function() {
        ...
        $resetButton.click(function() {
            ...
            var $handoutSuccessTag = $('.upload-success');
            if($resetButton.prev($handoutSuccessTag)){
              $handoutSuccessTag.removeClass('is-shown');
            }
        });
    ...
    $('.save-button', element).bind('click', function(e) {
        ...
        var filehandlerUrl = runtime.handlerUrl(element, 'save_file');
        $.ajax({
           url: filehandlerUrl,
            type: "POST",
            data: JSON.stringify({file: uploadFile})
        });
    });
    ...
    $('.setting-clear', element).on('click', function (event){
        var downloadButton = $(event.currentTarget).parent().find('.download-setting');
        if (downloadButton){
